...
\babelfont{rm}[
    Path = ../001-tensor-matrix/font/,
    BoldFont = {NotoSerifSC-ExtraBold.ttf},
    ItalicFont = {StKaiTi.ttf}
]{NotoSerifSC-Regular.ttf}
\babelfont{sf}[Path = ../001-tensor-matrix/font/]{GFSDidot-Regular.ttf}
\babelfont{tt}[Path = ../001-tensor-matrix/font/]{NotoSerifSC-Regular.ttf}
