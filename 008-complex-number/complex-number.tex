...
|z|^2 = z \overline{z},\\
|z_1 + z_2| \le |z_1| + |z_2| \quad \text{(三角不等式)}.
$$
...
若
\[
\forall x \in X, \beta \in Y^*:\ \langle x,f^* \beta \rangle = \langle f x, \beta \rangle,
\]
则互为伴随算子．
